...
- [ ] T017 [US2] Build + run: `mise exec -- pnpm -C packages/typescript build`; run T015 (esp. SC-003 parity + Norway-safe). Parity holds because the SAME Rust loader handles all three paths.
...
- [ ] T020 [US3] Build + run: `mise exec -- pnpm -C packages/typescript build`; run T018 (all finding kinds + purity).
