---
name: speckit-memory-md-init-project
description: Profile and configure project technical stack for cross-project shared
  memory sync channels.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: memory-md:commands/speckit.memory-md.init-project.md
---
