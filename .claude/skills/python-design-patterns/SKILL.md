...
- [python-testing-patterns](../../../apm_modules/wshobson/agents/plugins/python-development/skills/python-testing-patterns/SKILL.md) — Test each layer in isolation using the dependency injection structure established here
