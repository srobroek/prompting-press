...
2. **Proactive Check**: Before planning or tasking, you MUST prepare context using the best available path:
   - MCP: call `speckit_memory_refresh_cache`, `speckit_memory_search`, `speckit_memory_synthesize`, and `speckit_memory_synthesize_docs` if your Antigravity build exposes MCP tools
